...
namespace GuitarManagement.CommonDefine
{
    public class DefineMessage
    {
        ...
        public const string ADD_RECORD_SUCCESSFUL = "Thêm bản ghi mới thành công";
        public const string CONFIRM_EDIT = "Lưu lại các thay đổi?";
        public const string MODIFY_SUCCESSFUL = "Cập nhật thay đổi thành công";
        public const string DELETE_RECORD_SUCCESSFUL = "Đã xóa thành công";
        public const string ID_INVALID = "Id không hợp lệ";
        public const string ID_VALID = "Id hợp lệ";
